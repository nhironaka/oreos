...
const WIDTH = 887.77227;
const HEIGHT = 772.83071;
const RATIO = HEIGHT / WIDTH;

export default function LoginSplash({ className }) {
  ...
  React.useEffect(() => {
    const clientWidth = get(ref, 'current.clientWidth');
